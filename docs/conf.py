...
# If given, this must be the name of an image file that is the logo of the docs.
# It is placed at the top of the sidebar; its width should therefore not exceed
# 200 pixels. Default: None.
html_logo = '_static/3-LOGO-COACCH_horizontal-transparent.png'
...
latex_documents = [
    (master_doc, 'coacch.tex', 'COACCCH Data Repository',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'coacch', 'COACCCH Data Repository',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'coacch', 'COACCCH Data Repository',
     author, 'coacch', 'One line description of project.',
     'Miscellaneous'),
]
...
html_context['github_user'] = 'iiasa'
html_context['github_repo'] = 'COACCH'
